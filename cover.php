...
$alert = false;
    ...
    if (isset($_GET['deleteimg'])) {
        ...
        $sno = $_GET['deleteimg'];
        // $sql = "UPDATE cover SET photo = null WHERE `id` = '$sno'";
        // $result = mysqli_query($conn, $sql);

        $target_file="cover/img";
        $target_file = $target_file.$sno;
    ...
    if(isset($_POST['addphoto']) && !empty($_FILES["img"]["name"]) ){
        ...
        if(in_array($fileType, $allowTypes)){
            ...
            // $sql =  "UPDATE `cover` SET `photo` = '$imgContent' WHERE `cover`.`id` = '$id'";
            // $result = mysqli_query($conn, $sql);
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php
                    $target_file="cover/img";
                    $target_file = $target_file.$row['id'];
                    if(file_exists($target_file)){?>
